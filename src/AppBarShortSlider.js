...
import {AppBar, IconButton, Toolbar, Typography, Switch} from "@material-ui/core";
...
export default class AppBarShortSlider extends Component
{
    constructor(props) {
        super(props);
        this.state = {
    ...
    // slider(event){
    //     let temp = !(this.state.sliderCheck);

    //     this.setState({ sliderCheck : temp});
    // }
